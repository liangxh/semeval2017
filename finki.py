...
def main():
    ...
    optparser.add_option("-f", "--nb_filter", dest="nb_filter", type="int", default=1024)
    optparser.add_option("-r", "--rnn_output_dims", dest="rnn_output_dims", type="int", default=1024)
