...
def main():
    ...
    optparser.add_option("-f", "--nb_filter_pre", dest="nb_filter_pre_1", type="int", default=200)
    optparser.add_option("-f", "--nb_filter_pre", dest="nb_filter_pre_2", type="int", default=200)
